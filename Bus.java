...
public class Bus extends Transport {
	...
	public Bus(String brand, String model, double maxPermissibleMassTransportedCargo, int numberOfPassenger, int maxSpeed) {
	...
	public double getMaxPermissibleMassTransportedCargo() {
		...
		//Если прицеп есть, то мы возвращаем МахМассу автобуса+ МахМассу прицепа
		
		if (trailer != null) 
			return super.getMaxPermissibleMassTransportedCargo() + trailer.getMaxPermissibleMassTransportedCargo();
		
		//Если прицепа нет, то мы возвращаем МахМассу автобуса и всё
		else 
	...
	public int getMaxSpeed() {
		...
		//Если прицепа нет или скорость ТС была задана некорректно, то мы возвращаем скорость автобуса и всё
		else 
