...
public class Motorcycle extends Transport {
	...
	public double getMaxPermissibleMassTransportedCargo() {
		...
		//Если прицеп есть, то мы возвращаем МахМассу мотоцикла + МахМассу прицепа
		
		if (trailer != null) 
			return super.getMaxPermissibleMassTransportedCargo() + trailer.getMaxPermissibleMassTransportedCargo();
		
		//Если прицепа нет, то мы возвращаем МахМассу мотоцикла и всё
		else 
	...
	public int getMaxSpeed() {
		...
		//Если прицепа нет или скорость ТС была задана некорректно, то мы возвращаем скорость мотоцикла и всё
		else 
